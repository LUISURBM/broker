    ...
    <div class="dashboard-stat2 bluebox" style="cursor:pointer;" >
        <div class="display">
            <div class="number">
                ...
                <small class="font-green-sharp">SPECIMEN ACCESSION</small><br>
    ...
    <div class="dashboard-stat2 " style="cursor:pointer;" >
        <div class="display">
            <div class="number">
                ...
                <small class="font-blue-sharp">SPECIMEN TESTED</small><br>
    ...
    <div class="dashboard-stat2 " style="cursor:pointer;">
        <div class="display">
            <div class="number">
                ...
                <small class="font-purple-soft">SPECIMEN WAITING</small><br>
    ...
    <div class="dashboard-stat2 " style="cursor:pointer;" >
        <div class="display">
            <div class="number">
                ...
                <small class="font-red-haze">SPECIMEN REJECTED</small><br>
