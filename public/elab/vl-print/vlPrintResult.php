    ...
    <section class="content">
      <div class="row">
		...
		<tr>
		    <td><b>Site Name :</b></td>
		    <td>
		      <select class="form-control" id="facility" name="facility" title="Please select site name" multiple="multiple" style="width:220px;">
		      <option value=""> -- Select -- </option>
			<?php
		...
		<tr>
		  <td colspan="6">&nbsp;<input type="button" onclick="searchVlRequestData();" value="Search" class="btn btn-success btn-sm">
			...
			<a href="offSiteResultRecords.php" class="btn btn-primary btn-sm" target ="_blank"></i>Search External Requests Records</a>
