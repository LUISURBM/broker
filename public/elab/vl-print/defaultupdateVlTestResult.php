                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-3 col-md-3">
                        ...
                        <label for="dob">Date of Birth </label>
                          <input type="text" name="dob" id="dob" class="form-control date" placeholder="Enter DOB" title="Enter dob" value="<?php echo $vlQueryInfo[0]['patient_dob']; ?>" <?php echo $disableDemi;?>/>
                        </div>
                      </div>
                      <div class="col-xs-3 col-md-3">
                        <div class="form-group">
                          <label for="ageInYears">If DOB unknown, Age in Year </label>
                            <input type="text" name="ageInYears" id="ageInYears" class="form-control checkNum" maxlength="2" placeholder="Age in Year" title="Enter age in years" <?php echo $disableDemi;?> value="<?php echo $vlQueryInfo[0]['patient_age_in_years'];?>"/>
                          </div>
                      </div>
                      <div class="col-xs-3 col-md-3">
                        <div class="form-group">
                          <label for="ageInMonths">If Age < 1, Age in Month </label>
                            <input type="text" name="ageInMonths" id="ageInMonths" class="form-control checkNum" maxlength="2" placeholder="Age in Month" title="Enter age in months" <?php echo $disableDemi;?> value="<?php echo $vlQueryInfo[0]['patient_age_in_months'];?>"/>
                          </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-xs-3 col-md-3">
                        <div class="form-group">
                          <label for="patientFirstName">Patient First Name </label>
                            <input type="text" name="patientFirstName" id="patientFirstName" class="form-control" placeholder="Enter Patient First Name" title="Enter patient first name" <?php echo $disableDemi;?> value="<?php echo $vlQueryInfo[0]['patient_first_name'];?>"/>
                          </div>
                        <div class="form-group">
                          <label for="patientLastName">Patient Last Name </label>
                            <input type="text" name="patientLastName" id="patientLastName" class="form-control" placeholder="Enter Patient Last Name" title="Enter patient last name" <?php echo $disableDemi;?> value="<?php echo $vlQueryInfo[0]['patient_last_name'];?>"/>
                          </div>
                      ...
                      <div class="col-xs-3 col-md-3">
                        ...
                        <label for="gender">Gender</label><br>
                          <label class="radio-inline" style="margin-left:0px;">
                            <input type="radio" class="" id="genderMale" name="gender" value="male" title="Please check gender" <?php echo $disableDemi;?> <?php echo ($vlQueryInfo[0]['patient_gender']=='male')?"checked='checked'":""?>> Male
                            </label>
                          <label class="radio-inline" style="margin-left:0px;">
                            <input type="radio" class="" id="genderFemale" name="gender" value="female" title="Please check gender" <?php echo $disableDemi;?> <?php echo ($vlQueryInfo[0]['patient_gender']=='female')?"checked='checked'":""?>> Female
                          </label>
                      ...
                      <div class="col-xs-3 col-md-3">
                        ...
                        <label for="gender">SMS</label><br>
                          <label class="radio-inline" style="margin-left:0px;">
                            <input type="radio" class="" id="receivesmsYes" name="receiveSms" value="yes" title="Patient consent to receive SMS" <?php echo $disableDemi;?> onclick="checkPatientReceivesms(this.value);" <?php echo ($vlQueryInfo[0]['consent_to_receive_sms']=='yes')?"checked='checked'":""?>> Yes
                            </label>
                          <label class="radio-inline" style="margin-left:0px;">
                            <input type="radio" class="" id="receivesmsNo" name="receiveSms" value="no" title="Patient consent to receive SMS" <?php echo $disableDemi;?> onclick="checkPatientReceivesms(this.value);" <?php echo ($vlQueryInfo[0]['consent_to_receive_sms']=='no')?"checked='checked'":""?>> No
                          </label>
                        </div>
                      </div>
                      <div class="col-xs-3 col-md-3">
                        ...
                        <label for="patientPhoneNumber">Phone Number</label>
                          <input type="text" name="patientPhoneNumber" id="patientPhoneNumber" class="form-control checkNum" maxlength="15" placeholder="Enter Phone Number" title="Enter phone number" value="<?php echo $vlQueryInfo[0]['patient_mobile_number'];?>" <?php echo $disableDemi;?>/>
                        </div>
                      </div>
                   </div>
                </div>
                  ...
                  <div class="box-body">
                    <div class="row">
                      ...
                      <div class="col-xs-3 col-md-3">
                          ...
                          <select name="specimenType" id="specimenType" class="form-control isRequired" title="Please choose sample type" <?php echo $disableDemi;?>>
                                <option value=""> -- Select -- </option>
                                <?php
                           ...
                           <!-- Unique Identifier Input  -->
                                                      ...
                                                      <div class="col-xs-3 col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="uniqueIdentifier" id="uniqueIdentifier" class="form-control" placeholder="Enter Unique Identifier Information" title="Enter Unique Information"
                                                            value="<?php echo $vlQueryInfo[0]['patient_location'];?>"/>
                                                        </div>
                                                    </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                      <div class="col-xs-3 col-md-3">
                        ...
                        <label for="">Date of Treatment Initiation</label>
                          <input type="text" class="form-control labSection" name="dateOfArtInitiation" id="dateOfArtInitiation" placeholder="Date Of Treatment Initiation" title="Date Of treatment initiated" value="<?php echo $vlQueryInfo[0]['treatment_initiated_date']; ?>" <?php echo $disableDemi;?> style="width:100%;">
                        </div>
                      </div>
                      ...
                      <div class="col-xs-3 col-md-3">
                        ...
                        <label for="">Date of Initiation of Current Regimen </label>
                          <input type="text" class="form-control labSection" style="width:100%;" name="regimenInitiatedOn" id="regimenInitiatedOn" placeholder="Current Regimen Initiated On" title="Please enter current regimen initiated on" <?php echo $disableDemi;?> value="<?php echo $vlQueryInfo[0]['date_of_initiation_of_current_regimen']; ?>">
                        </div>
                      </div>
                      <div class="col-xs-3 col-md-3">
                        <div class="form-group">
                        <label for="arvAdherence">ARV Adherence </label>
                          <select name="arvAdherence" id="arvAdherence" class="form-control" title="Please choose adherence" <?php echo $disableDemi;?>>
                            <option value=""> -- Select -- </option>
                  ...
                  <div class="box box-primary">
                    ...
                    <div class="box-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                            <label class="col-lg-5 control-label" for="sampleTestingDateAtLab">Specimen Testing Date </label>
                            <div class="col-lg-7">
