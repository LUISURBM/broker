...
//    var_dump($_POST);die();
    ...
    $vldata=array(
          ...
          'patient_first_name'=>(isset($_POST['patientMiddleName']) && $_POST['patientMiddleName']!='') ? $_POST['patientMiddleName'] :  NULL,
          'patient_first_name'=>(isset($_POST['patientLastName']) && $_POST['patientLastName']!='') ? $_POST['patientLastName'] :  NULL,
