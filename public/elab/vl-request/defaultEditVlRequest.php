              ...
              <div class="box-body">
                    ...
                    <div class="row">
                      <div class="col-xs-3 col-md-3">
                        <div class="form-group">
						  ...
						  <?php
							if(isset($vlQueryInfo[0]['sample_code'])){
								$specid = $vlQueryInfo[0]['sample_code'];
							}else{
								$specid = $_GET['sid'];
							}
						  ?>
                          <input type="text" class="form-control isRequired <?php echo $sampleClass;?>" id="sampleCode" name="sampleCode" <?php echo $maxLength;?> placeholder="Enter Specimen ID" title="Please enter Specimen id" value="<?php echo $specid; ?>" style="width:100%;"/>
                        </div>
                      </div>
                      <div class="col-xs-3 col-md-3">
                        <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-xs-3 col-md-3">
                        ...
                        <label for="province">Region <span class="mandatory">*</span></label>
                          <select class="form-control isRequired" name="province" id="province" title="Please choose region" style="width:100%;" onchange="getProvinceDistricts(this);">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body">
                      ...
                      <div class="col-xs-3 col-md-3">
                        <div class="form-group">
                          <label for="patientFirstName">Patient First Name </label>
                            <input type="text" name="patientFirstName" id="patientFirstName" class="form-control" placeholder="Enter Patient First Name" title="Enter patient first name" value="<?php echo $vlQueryInfo[0]['patient_first_name'];?>"/>
                          </div>
                      </div>
                      <div class="col-xs-3 col-md-3">
                        <div class="form-group">
                          <label for="patientMiddleName">Patient Middle Name </label>
                            <input type="text" name="patientMiddleName" id="patientMiddleName" class="form-control" placeholder="Enter Patient Middle Name" title="Enter patient middle name" value="<?php echo $vlQueryInfo[0]['patient_middle_name'];?>"/>
                          </div>
                      </div>
                       <div class="col-xs-3 col-md-3">
                        <div class="form-group">
                          <label for="patientLastName">Patient Last Name </label>
                            <input type="text" name="patientLastName" id="patientLastName" class="form-control" placeholder="Enter Patient Last Name" title="Enter patient last name" value="<?php echo $vlQueryInfo[0]['patient_last_name'];?>"/>
                          </div>
                      </div>
                      <!--Last Name Input -->
                      <div class="col-xs-3 col-md-3">
                    ...
                    <!--  <div class="col-xs-3 col-md-3">
                        <div class="form-group">
                        <label for="gender">Patient consent to receive SMS?</label><br>  *********************************** Removed ? in php
                          <label class="radio-inline" style="margin-left:0px;">
                            <input type="radio" class="" id="receivesmsYes" name="receiveSms" value="yes" title="Patient consent to receive SMS" onclick="checkPatientReceivesms(this.value);" <php echo ($vlQueryInfo[0]['consent_to_receive_sms']=='yes')?"checked='checked'":""?>> Yes
                            </label>
                          <label class="radio-inline" style="margin-left:0px;">
                            <input type="radio" class="" id="receivesmsNo" name="receiveSms" value="no" title="Patient consent to receive SMS" onclick="checkPatientReceivesms(this.value);" <php echo ($vlQueryInfo[0]['consent_to_receive_sms']=='no')?"checked='checked'":""?>> No
                          </label>
                        </div>
                      </div>  -->
                      <div class="col-xs-3 col-md-3">
                ...
                <div class="box box-primary">
                  ...
                  <div class="box-body">
                    ...
                    <div class="row ">
                      <div class="col-xs-3 col-md-3 femaleSection" style="display:<?php echo ($vlQueryInfo[0]['patient_gender']=='female' || $vlQueryInfo[0]['patient_gender']=='' || $vlQueryInfo[0]['patient_gender']== null)?"":"none"?>";>
                        <div class="form-group">
                    ...
                    <div class="box-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4 rejectionReason" style="display:<?php echo($vlQueryInfo[0]['is_sample_rejected'] == 'yes')?'':'none'; ?>;">
                            ...
                            <div class="col-lg-30">
                              <select multiple name="rejectionReason" id="rejectionReason"  class="form-control labSection " title="Please choose reason" onchange="checkRejectionReason();">
                                <option value="">-- Select --</option>
                      ...
                      <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="col-lg-7">
                              <select name="approvedBy" id="approvedBy" class="form-control labSection" title="Please choose verified by">
                                <option value="">-- Select --</option>
                                <?php
