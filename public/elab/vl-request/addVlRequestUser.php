...
<!--                                    <li><a href="#laboratoryInformation" data-toggle="tab">Laboratory Information</a></li>-->
                                ...
                                <div id="myTabContent" class="tab-content" >
                                    ...
                                    <div class="tab-pane fade" id="specimenInformation">
                                        ...
                                        <div class="box-footer">
                                            <a class="btn btn-primary" href="#treatmentInformation" data-toggle="tab">Save and Next</a>
                                            <a href="vlRequest.php" class="btn btn-default"> Cancel</a>
                                        </div>
                                    </div>
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="row ">
                                                        <div class="col-xs-3 col-md-3 femaleSection">
                                                            <div class="form-group">
                                                                <label for="patientPregnant">Is Patient Pregnant?(Females Only) </label><br>
                                                        ...
                                                        <div class="col-xs-3 col-md-3 femaleSection">
                                                            <div class="form-group">
                                                                <label for="breastfeeding">Is Patient Breastfeeding?(Females Only) </label><br>
                                                                <label class="radio-inline">
