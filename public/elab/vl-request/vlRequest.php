      ...
      <div class="row">
	    ...
	    <table id="filter" class="table" cellpadding="1" cellspacing="3" style="margin-left:1%;margin-top:20px;width: 98%;margin-bottom: 0px;">
		  ...
		  <td>
		    ...
		    <?php
		      ...
		      ?>
		      &nbsp;<button class="btn btn-primary btn-sm pull-right" style="margin-right:5px;" onclick="$('#showhide').fadeToggle();return false;"><span>Manage Columns</span></button>
		    &nbsp;<a class="btn btn-success btn-sm pull-right" style="margin-right:5px;" href="javascript:void(0);" onclick="exportAllExcel();"><i class="fa fa-cloud-download" aria-hidden="true"></i> Export Excel</a>
	    ...
	    <span style="display: none;position:absolute;z-index: 9999 !important;color:#000;padding:5px;" id="showhide" class="">
			<div class="row" style="background:#e0e0e0;float: right !important;padding: 15px;">
			    <div class="col-md-12" >
				    <div class="col-md-3">
					    <input type="checkbox" onclick="javascript:fnShowHide(this.value);" value="0" id="iCol0" data-showhide="serial_no" class="showhideCheckBox" /> <label for="iCol0">Specimen Code</label>
				    </div>
				    <div class="col-md-3">
					    <input type="checkbox" onclick="javascript:fnShowHide(this.value);" value="1" id="iCol1" data-showhide="sample_collection_date" class="showhideCheckBox"  /> <label for="iCol1">Specimen Collection Date</label>
				    </div>
				    <div class="col-md-3">
					    <input type="checkbox" onclick="javascript:fnShowHide(this.value);" value="2" id="iCol2" data-showhide="batch_code" class="showhideCheckBox"  /> <label for="iCol2">Batch ID</label> <br>
				    </div>
				    <div class="col-md-3">
				    ...
				    <div class="col-md-3">
					    <input type="checkbox" onclick="javascript:fnShowHide(this.value);" value="5" id="iCol5" data-showhide="facility_name"  class="showhideCheckBox" /> <label for="iCol5">Site Name</label>
				    </div>
				    <div class="col-md-3">
					    <input type="checkbox" onclick="javascript:fnShowHide(this.value);" value="6" id="iCol6" data-showhide="state"  class="showhideCheckBox" /> <label for="iCol6">Region</label>
				    </div>
				    <div class="col-md-3">
				    ...
				    <div class="col-md-3">
					    <input type="checkbox" onclick="javascript:fnShowHide(this.value);" value="8" id="iCol8" data-showhide="sample_name"  class="showhideCheckBox" /> <label for="iCol8">Specimen Type</label>
				    </div>
				    <div class="col-md-3">
				    ...
				    <div class="col-md-3">
					    <input type="checkbox" checked onclick="javascript:fnShowHide(this.value);" value="11" id="iCol10" data-showhide="action" class="showhideCheckBox" /> <label for="iCol11">Action</label>
				    </div>
				</div>
			    </div>
			</span>
