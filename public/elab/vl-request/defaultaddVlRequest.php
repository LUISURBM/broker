...
//get active specimen pickers
$spQuery="SELECT * from r_specimen_pickers where status='active'";
$spResult=$db->query($spQuery);
//regimen heading
...
{
    $svlQuery='SELECT sample_code_key FROM vl_request_form as vl ORDER BY vl_sample_id DESC LIMIT 1';
}
...
<!--                                <li><a href="#laboratoryInformation" data-toggle="tab">Laboratory Information</a></li>-->
                            ...
                            <div id="myTabContent" class="tab-content" >
                                <div class="tab-pane fade in active" id="clinicInformation">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-3 col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" style="width:100%;" name="fCode" id="fCode" placeholder="ART Center Code" title="Please enter ART center code">
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <a class="btn btn-primary next-btn" target-tab="patientInformation">Save and Next</a>
                                ...
                                <div class="tab-pane fade" id="patientInformation">
                                        ...
                                        <input type="radio" class="" id="isPatientNewNo" name="isPatientNew" value="no" />
                                                    ...
                                                    <div class="col-xs-3 col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="ageInYears" id="ageInYears" class="form-control checkNum isRequired"  placeholder="Age in Year" title="Enter age in years"/>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-3 col-md-3">
                                                        <div class="form-group">
                                    ...
                                    <div class="box-footer">
                                    <a class="btn btn-primary next-btn" target-tab="specimenInformation" >Save and Next</a>
                                    <a href="vlRequest.php" class="btn btn-default"> Cancel</a>
                                </div>
                                </div>
                                <div class="tab-pane fade" id="specimenInformation">
                                    ...
                                    <div class="box-footer">
                                    <a class="btn btn-primary next-btn" target-tab="treatmentInformation" >Save and Next</a>
                                    <a href="vlRequest.php" class="btn btn-default"> Cancel</a>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="treatmentInformation">
                                         ...
                                         <!-- Regimen Funtion to allow user input -->
                                                ...
                                                <div class="row ">
                                                    <div class="col-xs-3 col-md-3 femaleSection">
                                                        <div class="form-group">
                                                            <label for="patientPregnant">Is Patient Pregnant? (Female's Only) </label><br>
                                                    ...
                                                    <div class="col-xs-3 col-md-3 femaleSection">
                                                        <div class="form-group">
                                                            <label for="breastfeeding">Is Patient Breastfeeding?(Female's Only) </label><br>
                                                            <label class="radio-inline">
                                    ...
                                    <div class="box-footer">
                                    <a class="btn btn-primary next-btn" target-tab="viralInformation" >Save and Next</a>
                                    <a href="vlRequest.php" class="btn btn-default"> Cancel</a>
                                </div>
                                </div>
...
<!--        </div>-->
  ...
  // BARCODESTUFF END
        ...
        $(".next-btn").click(function(){
			var targetID = $(this).attr('target-tab');
  ...
  function setPatientDetails(pDetails){
	  ...
	  var artnum = $("#artPatientNo").val().trim();
                                                         //Initail Code // $("#patientFirstName").val(patientArray[0]+" "+patientArray[1]); Next two lines recent
	  $("#artNo").val(artnum);
      ...
      if($.trim(patientArray[13])!=''){
          $("#rmTestingVlValue").val($.trim(patientArray[13]));
      }
  }
  // Funtion to search patient name, initially first & last names pop up. NB: Filter search reults
