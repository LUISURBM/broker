 ...
 * DiRequestForm
 *
 * @ORM\Table(name="di_request_form", uniqueConstraints={@ORM\UniqueConstraint(name="sample_code", columns={"sample_code"})}, indexes={@ORM\Index(name="sample_id", columns={"sample_type"}), @ORM\Index(name="status", columns={"result_status"}), @ORM\Index(name="facility_id", columns={"facility_id"}), @ORM\Index(name="art_no", columns={"patient_art_no"}), @ORM\Index(name="created_by", columns={"request_created_by"})})
 * @ORM\Entity
 */
class DiRequestForm
{
